...
class Game:
    ...
    def save_game(self):
        #self.trace.actions#save game data here
        #self.board.get_percepts#save game data here
        #self.trace.winner#save game data here

        #we need to save all boards from start to end!
        pass
